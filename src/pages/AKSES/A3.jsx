...
import s from './A3.module.scss'
import w from '../../img/U4.webp'
import q from '../../img/U5.webp'
import g from '../../img/ф4.webp'
// import f from '../../img/j44.jpg'
...
const P1 = () => {
  ...
  const [img, setImg] = useState(g)
  const [text, setText] = useState(3500 + ' сом')
  // const a = 750 + ' сом';
  // const d = 790 + ' сом';
  // const v = 850 + ' сом';
  // const c = 990 + ' сом';
  return (
    <div className={s.block}>
      ...
      <div className={s.block2}>
        <div>
          <h5>Кошелек BLUE SQUARE</h5>

          <div className={s.blockk}>
            <p style={{opacity:"0"}}>{t("p.p1")}</p>
            <div className={s.btn}>
